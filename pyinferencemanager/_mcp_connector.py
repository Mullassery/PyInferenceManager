...
class InferenceManager:
    ...
    def start_mcp_connector(self, port: int = 8776) -> str:
        from pyinferencemanager._mcp_tools import PyInferenceManagerMCPHandler, PyInferenceManagerMCPTools
        self.mcp_connector = _MCPInferenceConnector(manager=self, port=port)
...
class _MCPInferenceConnector(BaseMCPConnector):
    def __init__(self, manager: InferenceManager, port: int = 8776):
        super().__init__("PyInferenceManager", port=port)
